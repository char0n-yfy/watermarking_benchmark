...
EXECUTION_ENV_VARS = (
    ...
    "WM_BENCH_IMAGE_METADATA_CACHE",
    "WM_BENCH_IMAGE_METADATA_CACHE_MAX_ENTRIES",
    "WM_BENCH_QUALITY_PAIR_CACHE",
    "WM_BENCH_QUALITY_PAIR_CACHE_MAX_ENTRIES",
    "WM_BENCH_IMAGE_IO_WORKERS",
    "WM_BENCH_IMAGE_PREFETCH",
    "WM_BENCH_IMAGE_IO_SAVE_WORKERS",
    "WM_BENCH_ASYNC_IMAGE_SAVE",
    "WM_BENCH_ASYNC_IMAGE_SAVE_MAX_PENDING",
    "WM_BENCH_3D_SCENE_CACHE",
    "WM_BENCH_3D_SCENE_CACHE_MAX_ENTRIES",
    "WM_BENCH_CEW_STEP_CACHE",
    "WM_BENCH_CEW_STEP_CACHE_MAX_ENTRIES",
    "WM_BENCH_LOG_DIR",
)
