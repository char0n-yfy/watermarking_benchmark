...
def _load_riva_watermark():
    raise RuntimeError('RivaGAN is not packaged for this DWT-DCT-SVD watermark method')
...
class WatermarkEncoder(object):
    ...
    @classmethod
    def loadModel(cls):
        _load_riva_watermark().loadModel()
    ...
    def encode(self, cv2Image, method='dwtDct', **configs):
        ...
        if method == 'dwtDct':
            ...
            RivaWatermark = _load_riva_watermark()
