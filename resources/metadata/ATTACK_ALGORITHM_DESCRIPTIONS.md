...
| 25 | `image_to_vedio` | NFPA image-to-video next-frame prediction 攻击；项目 ID 保留 `vedio` 拼写。它使用 vendored Diffusers next-frame pipeline，把单图通过视频式下一帧预测再生成。 | [NFPA, NeurIPS 2025 (OpenReview)](https://openreview.net/forum?id=yO2zE1yIYZ)<br>[Latent Diffusion Models, arXiv:2112.10752](https://arxiv.org/abs/2112.10752) | [1249748036/NFPA](https://github.com/1249748036/NFPA)<br>项目后端：`evaluator/attacks/regeneration_attacks/backends/nfpa/` |
