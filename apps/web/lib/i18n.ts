...
export const translations = {
  zh: {
    ...
    resources: {
      ...
      weightsUnavailable: "水印算法权重包尚未就绪，请手动放入本地目录或上传到 OSS。",
      ...
      attackWeightsUnavailable: "攻击算法权重包尚未就绪，请手动放入本地目录或上传到 OSS。",
  ...
  en: {
    ...
    resources: {
      ...
      weightsUnavailable: "Watermark weight pack is not ready. Place files locally or upload to OSS.",
      ...
      attackWeightsUnavailable: "Attack weight pack is not ready. Place files locally or upload to OSS.",
